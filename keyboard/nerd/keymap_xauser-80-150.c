...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP_80(\
      ...
      LCTL,LGUI,LALT,               SPC,                NO,  FN1, RGUI,RCTL,      LEFT,DOWN,RGHT),\
  /* layer 1: space fn */
  KEYMAP_80(\
      ...
      TRNS,TRNS,TRNS,               FN4,                NO,  TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS),\
  /* layer 2: gaming */
  KEYMAP_80(\
      TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS, \
      TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS, \
      ...
      TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,NO,             TRNS,      \
      TRNS,NO,  TRNS,               TRNS,               NO,  TRNS,NO,  TRNS,      TRNS,TRNS,TRNS),\
  /* layer 3: first function layer */
  KEYMAP_80(\
      TRNS,     FN8, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS, \
      FN5, FN6, FN7, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS, \
      ...
      TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,BTN3,BTN2,PGUP,TRNS,TRNS,TRNS,NO,             TRNS,      \
      TRNS,TRNS,TRNS,               BTN1,               NO,  TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS),\
  ...
  KEYMAP_80(\
      ...
      CAPS,TRNS,TRNS,TRNS,TRNS,TRNS,LEFT,DOWN,UP,  RGHT,MPRV,MNXT,NO,  MPLY,                      \
      TRNS,NO,  SLEP,TRNS,CALC,TRNS,WFAV,FN9, PGDN,PGUP,TRNS,TRNS,TRNS,NO,             TRNS,      \
