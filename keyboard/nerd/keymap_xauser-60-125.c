...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP_60(ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC,
            ...
            LSFT,NO,  Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,RSFT,DEL,
            LCTL,LGUI,LALT,               SPC,                FN1, RGUI,APP, RCTL),
  /* layer 1: space fn */
  KEYMAP_60(FN2, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
            ...
            TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,RSFT,TRNS,
            TRNS,TRNS,TRNS,               FN4,                TRNS,RGUI,APP, RCTL),
  /* layer 2: gaming */
  KEYMAP_60(TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
            ...
            TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,UP,  TRNS,
            TRNS,FN5, TRNS,               TRNS,               TRNS,LEFT,DOWN,RGHT),
  /* layer 3: first function layer */
  KEYMAP_60(FN6, FN7, FN8, FN9, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
            ...
            TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,BTN3,BTN2,TRNS,TRNS,TRNS,TRNS,TRNS,
            TRNS,TRNS,TRNS,               BTN1,               TRNS,TRNS,TRNS,TRNS),
  /* layer 4: second function layer */
  KEYMAP_60(GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, TRNS,
            ...
            TRNS,NO,  SLEP,TRNS,CALC,TRNS,WFAV,FN10,PGDN,PGUP,TRNS,TRNS,TRNS,TRNS,
